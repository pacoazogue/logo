...
function Dibujo(logo, nom_canvas) { /*****************************************/
...
Dibujo.prototype.ajoute =  function (n, o, d, couleur, epaisseur) { /*********/
    var i, e, ajout = true;
    i = this.lst.length - 1;
    if (i >= 0) {
        e = this.lst[i];
...
Dibujo.prototype.ligne = function (n, o, d, couleur, epaisseur) { /***********/
...
Dibujo.prototype.remplir = function (x, y, fillcolor) { /*********************/
    var ctx = this.canvas.getContext("2d");
    ctx.floodfill(x, y, fillcolor, this.largeur, this.hauteur);
}; // Dessin.remplir

Dibujo.prototype.toSVG = function (f, code) { /*******************************/
...
Dibujo.prototype.vide = function () { /***************************************/
    this.lst = [];
    var ctx = this.canvas.getContext("2d");
